const STRINGS = {
  zh: {
    ...
    monitor_subtitle: "本机状态和家用命令台应用资源占用。",
    monitor_host: "主机",
    monitor_cpu: "CPU",
    monitor_cores: "核",
    monitor_memory: "内存",
    ...
    monitor_range: "时间范围",
    monitor_all: "全部",
    monitor_requests: "请求数",
    monitor_active_days: "活跃日",
    monitor_errors: "错误请求",
    monitor_methods: "种 method",
    monitor_traffic: "流量",
    monitor_latency: "平均耗时",
    monitor_commits: "次提交",
    monitor_commits_30d: "30 天提交",
    monitor_dev_days: "开发日",
    monitor_since_commit: "距上次提交",
    monitor_dirty: "有未提交修改",
    monitor_clean: "工作区干净",
    monitor_top_routes: "常用路由",
    monitor_repo: "Repo",
    monitor_git_ready: "Git 可用",
    monitor_git_unavailable: "Git 不可用",
    monitor_no_data: "暂无数据",
    monitor_loading: "正在加载统计数据…",
    monitor_stats_load_error: "无法加载统计数据",
  },
  en: {
    open: "Open",
    use: "Use",
    ...
    monitor_subtitle: "This computer and resource usage of Home Command Center apps.",
    monitor_host: "Host",
    monitor_cpu: "CPU",
    monitor_cores: "cores",
    ...
    monitor_stats: "Statistics",
    monitor_range: "Range",
    monitor_all: "All",
    monitor_requests: "Requests",
    monitor_active_days: "active days",
    monitor_errors: "Errors",
    monitor_methods: "methods",
    monitor_traffic: "Traffic",
    monitor_latency: "Avg latency",
    monitor_commits: "commits",
    monitor_commits_30d: "30-day commits",
    monitor_dev_days: "dev days",
    monitor_since_commit: "Since last commit",
    monitor_dirty: "Uncommitted changes",
    monitor_clean: "Clean worktree",
    monitor_top_routes: "Top routes",
    monitor_repo: "Repo",
    monitor_git_ready: "Git available",
    monitor_git_unavailable: "Git unavailable",
    monitor_no_data: "No data",
    monitor_loading: "Loading statistics…",
    monitor_stats_load_error: "Unable to load statistics",
  },
};
